...
namespace takeAwayWebApi.Helper
{
    public class WXPayHelperHere
    {
        ...
        public string CreateWXOrder(decimal totalAmount, string outTradeNo, string notifyUrl, string Spbill_create_ip)
        {
            ...
            var xml = StringHelperHere.Instance.GetWX_XML(appId, "1", body, mchId, nonce_str, notify_url, out_trade_no, spbill_create_ip, total_fee, trade_type, sign);
